...
public abstract class finalRobot extends LinearOpMode {
    ...
    public Servo wobbleGoalArm2;
    public Servo shooterFlap;
    ...
    public static finalRobot running_opmode;
    ...
    public void runOpMode(){
        ...
        if (initialize_hardware){
            ...
            wobbleGoalArm=(Servo)hardwareMap.get("wobbleGoalArm");
            wobbleGoalArm.setDirection(Servo.Direction.REVERSE);
            wobbleGoalArm2=(Servo)hardwareMap.get("wobbleGoalArm2");

            intakeWinch = (CRServo)hardwareMap.get("intakeWinch");
            feeder = (CRServo)hardwareMap.get("feeder");
 ...
 /*           int target_tollerance = 10;
            ...
            leftBackDrive.setTargetPositionTolerance(target_tolerance);
            ...
            leftFrontDrive.setTargetPositionTolerance(target_tolerance);
            ...
            rightBackDrive.setTargetPositionTolerance(target_tolerance);
            ...
            rightFrontDrive.setTargetPositionTolerance(target_tolerance);*/
        }
